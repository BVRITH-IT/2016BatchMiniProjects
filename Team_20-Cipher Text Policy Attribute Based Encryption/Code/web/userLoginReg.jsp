...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="wrapper">
            <div id="header">
                <div id="logo">
                    <h3>Cipher Text Policy Attribute Based Encryption</h3>
                </div>
                <div id="menu">
                    <ul>
                        <p class="first current_page_item"><a href="index.jsp">UserReg</a></p>
                        <p class="last"><a href="domAuthReg.jsp">UserLogin</a></p>
                    </ul>
                    <br class="clearfix" />
                </div>
            </div>
