...
th, td {  
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	  ...
	  <section class="hero-wrap js-fullheight" style="background-image: url('images/viewappointment.jpg');" data-section="home" data-stellar-background-ratio="0.5">
...
String val=request.getParameter("dname");

String QueryString = "SELECT name,gnd,age,date,time,doctorname,hospital from makeappointment_details where doctorname='"+val+"' ";
...
<TABLE >
            ...
            <TR>
                ...
                <TD><form action="insert.jsp">
                <input type="text" name="uname" placeholder="Enter Patient Name">
                <select name="status" action="insert.jsp">
			 	<option value="">--Accept/Delete--</option>
