...
th, td {  
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	  ...
	  <section class="hero-wrap js-fullheight" style="background-image: url('images/book.jpg');" style="width:50px; height:50px;"data-section="home" data-stellar-background-ratio="0.5">
...
<TABLE>
            ...
            <TR>
                ...
                <TD> <a href="utype3.html#makeappointment-section">Book Appointment</a></TD>
