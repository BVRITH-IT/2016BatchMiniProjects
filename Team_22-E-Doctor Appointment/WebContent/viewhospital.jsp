...
th, td {  
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	  ...
	  <section class="hero-wrap js-fullheight" style="background-image: url('images/bg1.jpg');" data-section="home" data-stellar-background-ratio="0.5">
...
String val=request.getParameter("hname");

String QueryString = "SELECT * from registeredhospital_details where hosp_name='"+val+"' ";
