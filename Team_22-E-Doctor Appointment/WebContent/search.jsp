...
th, td {  
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	  ...
	  <section class="hero-wrap js-fullheight" style="background-image: url('images/search.jpg');" data-section="home" data-stellar-background-ratio="0.5">
...
<TABLE>
            ...
            <TR>
                ...
                <TD> <a href="doregister.html">Book Appointment</a></TD>
            </TR>
            <% } %>
        </TABLE>
        </center>
